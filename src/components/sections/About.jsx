...
export const About = () => {
  ...
  return (
    <section id="about" className=" flex items-center justify-center py-30">
      <RevealOnScroll>
        <div className="max-w-4xl mx-auto px-4 mb-">
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 hover:border-green-300/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            <p className="text-gray-200 mb-6 text-center">
              Passionate developer at the beginning of the journey and i like to
              practice everyday something new to increase my knowledge.
            </p>
