          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-green-300/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Water-pixel/WeatherProject"
                  className="text-green-400 hover:text-green-200 transition-colors my-4"
                  target="_blank"
                >
                  View Project →
                </a>
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Water-pixel/FirstApplication"
            ...
            >
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Water-pixel/MusicProject"
                  className="text-green-400 hover:text-green-300 transition-colors my-4"
                  target="_blank"
                >
                  View Project →
